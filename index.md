---
title: "Programmierung 1 – Einführung in C#"
layout: single
author_profile: true
author: Erik Rodner
lecture_name: "Programmierung 1"
lecture_desc: "Einführung in die Programmierung mit C#"
licence: "CC-BY"
...
0. [Einstieg](/lectures/00/00.md) – Compiler- vs. Interpretersprachen, .NET-Plattform, Werkzeuge

### Teil 1: Grundlagen

1. [Hallo, Welt! – Einstieg in C#](/lectures/01/01.md) – Erstes C#-Programm, Entwicklungsumgebung, Grundstruktur
2. [Typen, Variablen und Werte](/lectures/02/02.md) – Datentypen, Variablen, Literale
3. [Fehler finden und beheben](/lectures/03/03.md) – Fehlerarten, Debugger, systematisches Vorgehen
4. [Rechnen und Vergleichen – Operatoren](/lectures/04/04.md) – Arithmetik, Vergleich, Logik
...
7. [Text und Eingabe – Strings und Konsole](/lectures/07/07.md) – Strings, Konsolenein- und -ausgabe, Formatierung
8. [Daten in Reihe – Arrays](/lectures/08/08.md) – Arrays: eindimensional, mehrdimensional
9. [Code strukturieren – Methoden](/lectures/09/09.md) – Methoden, Parameter, Rückgabewerte, Rekursion
...
13. [Robuster Code – Ausnahmebehandlung](/lectures/13/13.md) – `try`, `catch`, `finally`
...
1. Einfache **Programme in C# selbstständig schreiben und ausführen**.
2. **Variablen, Datentypen und Operatoren** gezielt einsetzen.
3. **Kontrollstrukturen** (Bedingungen, Schleifen) korrekt verwenden.
4. **Methoden** zur Strukturierung von Code einsetzen.
5. Grundprinzipien der **objektorientierten Programmierung** anwenden.
6. Laufzeitfehler mit **Ausnahmebehandlung** abfangen.
7. **Debuggen** und Fehler systematisch finden.
